...
var User = function () {
    ...
    var User = _classThis = /** @class */ (function () {
        function User_1() {
            ...
            this.role = (__runInitializers(this, _username_extraInitializers), __runInitializers(this, _role_initializers, void 0)); // e.g., 'SOLICITANTE', 'GESTOR_DADM', 'ADMIN_TEC'
            // Optional password hash (nullable for migration/backwards compatibility)
            this.password_hash = (__runInitializers(this, _role_extraInitializers), __runInitializers(this, _password_hash_initializers, void 0));
            __runInitializers(this, _password_hash_extraInitializers);
        }
        return User_1;
    }());
    ...
    (function () {
        ...
        _role_decorators = [(0, typeorm_1.Column)({ default: "SOLICITANTE" })];
        _password_hash_decorators = [(0, typeorm_1.Column)({ type: 'varchar', nullable: true })];
