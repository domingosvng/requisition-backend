// Update Fornecedores component to mark required fields properly
const fs = require('fs');
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
                ...
                <div style="grid-column:1 / -1;">
                    ...
                    <input 
                        ...
                        placeholder="Materiais, Serviços, Transporte, Manutenção" 
...
console.log('✅ Fornecedores.vue updated with required field indicators and improved validation!');