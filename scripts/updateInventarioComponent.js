// Script to create improved Inventario.vue with better error handling
const fs = require('fs');
            ...
            <div style="display:grid; grid-template-columns:1fr 1fr; gap:8px;">
                ...
                <div>
                    <input 
                        ...
                        placeholder="Categorias (vírgula)" 
    ...
    methods: {
        ...
        validateForm() {
            ...
            if (this.form.quantidade == null || this.form.quantidade < 0) {
                errors.quantidade = 'Quantidade deve ser um número válido maior ou igual a 0';
            }
...
console.log('✅ Inventario.vue updated with improved error handling!');